package com.llf.framework;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.llf.controller.IndexController;
import com.llf.controller.UserController;
...
//    private List<Class<?>> controllers = List.of(IndexController.class, UserController.class);
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp,
                         Map<String, ? extends AbstractDispatcher> dispatcherMap) throws IOException {
